...
import { View, Animated, Easing, Platform, TouchableWithoutFeedback, StyleSheet, I18nManager } from 'react-native';
const radius = 10;
...
export default class Ripple extends PureComponent {
    ...
    startRipple(event) {
        ...
        let locationXRTL = Math.abs(locationX - width)

        let ripple = {
            unique: this.unique++,
            progress: new Animated.Value(0),
            locationX: I18nManager.isRTL ? locationXRTL : locationX,
            locationY,
            R,
        };
