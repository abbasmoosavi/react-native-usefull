        ...
        return (
            <UFRN.Ripple
                ...
                style={[{
                    ...
                    borderRadius: radius, backgroundColor, height, width, justifyContent: 'center', alignItems: 'center', alignSelf: 'center', flexDirection: 'row', shadowColor: shadow,
                    shadowOffset: {
                        width: 0,
                        height: shadowHeight,
                    },
                ...
                <View style={{ height: '100%', width: '75%', flexDirection: 'row', alignItems: 'center' }}>
                    <UFRN.Image resizeMode={'contain'} tintColor={imageTintColor} style={[{ height: wp('6%'), width: wp('6%') }, imageStyle]} source={imageSource} />
                    <Text style={[{ marginStart: wp('2%'), color: textColor, fontSize }, textStyle]}>{text}</Text>
                </View>
                <View style={{ height: '100%', width: '25%', justifyContent: 'center', alignItems: 'flex-end' }}>
                    <UFRN.Image resizeMode={'contain'} tintColor={imageTintColor} style={[{ height: wp('4%'), width: wp('4%') }, iconStyle]} source={iconSource} />
                </View>
